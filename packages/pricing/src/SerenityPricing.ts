...
interface SerenityPricingElement extends HTMLElement {
  ...
  ctaUrl?: SerenityPricingProps["ctaUrl"];
  typeOfPrice?: SerenityPricingProps["typeOfPrice"];
  theme?: SerenityPricingProps["theme"];
  language?: SerenityPricingProps["language"];
}
...
export class SerenityPricing {
  ...
  public setProperties(options: Partial<SerenityPricingProps>) {
    ...
    if (options.ctaUrl !== undefined) {
      this.webComponent.ctaUrl = options.ctaUrl;
    }
    if (options.typeOfPrice !== undefined) {
      this.webComponent.typeOfPrice = options.typeOfPrice;
    }
    if (options.theme !== undefined) {
      this.webComponent.theme = options.theme;
    }
    if (options.language !== undefined) {
      this.webComponent.language = options.language;
    }
  }
  ...
  public get<K extends keyof SerenityPricingProps>(
    ...
    switch (key) {
      ...
      case "ctaUrl":
        return this.webComponent.ctaUrl as SerenityPricingProps[K];
      case "typeOfPrice":
        return this.webComponent.typeOfPrice as SerenityPricingProps[K];
      case "theme":
        return this.webComponent.theme as SerenityPricingProps[K];
      case "language":
        return this.webComponent.language as SerenityPricingProps[K];
      default:
        return undefined;
    }
  }
